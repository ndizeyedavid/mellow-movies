...
const movieTitles: Array<[string, string, number, string, string, string]> = [
  ...
  ['Avatar: The Way of Water', 'Sci-Fi · Adventure', 2022, '7.6', '3h 12m', '4K'],
]
...
export const movies: MediaItem[] = movieTitles.map(([title, genre, year, rating, duration, quality], i) => ({
  id: `movie-${i + 1}`,
  title,
  genre,
  year,
...
export const shows: MediaItem[] = showTitles.map(([title, genre, year, rating, duration, quality], i) => ({
  id: `show-${i + 1}`,
  title,
  genre,
  year,
...
export const footerColumns: FooterColumn[] = [
  ...
  { title: 'Movies & Shows', links: ['All Movies', 'All Shows', 'New Releases', 'Trending'] },
  { title: 'Support', links: ['Help Center', 'Contact Us', 'Terms of Use', 'Privacy Policy', 'Legal'] },
