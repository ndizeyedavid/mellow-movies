...
export function proxifyMediaUrl(url: string): string {
  ...
  // Hosted now proxies exactly like local per user request — Network should
  // show https://mellow-movies.fastapicloud.dev/api/proxy/mp4?u=... instead
  // of direct https://bcdnxw.hakunaymatata.com/... for both.
