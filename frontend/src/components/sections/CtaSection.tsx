  ...
  return (
    <section className="mx-auto w-full max-w-[1920px] px-5 sm:px-8 lg:px-[60px] xl:px-[121px] 2xl:px-[162px]">
      <div className="relative overflow-hidden rounded-xl border border-line bg-surface">
        ...
        <div className="pointer-events-none absolute inset-0 flex flex-col gap-5" aria-hidden="true">
          {banners.map((src) => (
            <img
              key={src}
              src={src}
        ...
        <div className="relative flex flex-col items-start gap-10 px-6 py-14 sm:px-10 md:flex-row md:items-center md:justify-between lg:gap-[100px] lg:px-[80px] lg:py-[100px]">
          <div className="flex max-w-xl flex-col gap-3.5">
            <h2 className="text-3xl font-bold leading-snug text-white md:text-4xl lg:text-[48px]">
